...
from app.recorder.can_logger import MIN_SIZE_MB, MAX_SIZE_MB, logger_root
...
class SettingsPanel(QWidget):
    ...
    def _build_workspace_page(self) -> QWidget:
        ...
        self._ws_table.setFocusPolicy(Qt.FocusPolicy.NoFocus)
    ...
    def _on_logger_dir_reset(self):
        """恢复默认: 保存目录/logger"""
        from app.common.workspace import WorkspaceManager as WM
